                    ...
                    <div class="modal-actions">
                        ...
                        ${project.links.playstore ? `
                            <a href="${project.links.playstore}" target="_blank" class="btn btn-primary">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M1.9 0C.85 0 0 .85 0 1.9v20.2C0 23.15.85 24 1.9 24h20.2c1.05 0 1.9-.85 1.9-1.9V1.9C24 .85 23.15 0 22.1 0H1.9zm10.44 7.8l6.77 6.77-2.48 2.48-6.77-6.77 2.48-2.48zm-1.54 1.54L4.03 15.1l2.48 2.48 6.77-6.77-2.48-2.48zM18.88 5.12l-6.77 6.77 2.48 2.48 6.77-6.77-2.48-2.48zM4.03 8.9l6.77 6.77-2.48 2.48L1.55 11.38 4.03 8.9z"/>
                                </svg>
